...
public class StringBuilderMultilineTextModel implements MultilineTextModel, EditableTextModel {
    ...
    public void insert(int i, String part) {
        lines = null;
        StringUtilities.insert(text, i, part);
    }

    @Override
    public void remove(int iBegin, int iEnd) {
        lines = null;
        StringUtilities.delete(text, iBegin, iEnd);
    }
